...
assignRouter.use(authenticate, minRole('ICT_TECHNICIAN'));
assignRouter.get('/', assignments.listAssignments);
assignRouter.post('/', assignments.assignAsset);
assignRouter.post('/:id/return', assignments.returnAsset);
assignRouter.post('/:id/transfer', assignments.transferAsset);
...
attachRouter.delete('/:id', authenticate, minRole('ICT_TECHNICIAN'), attachments.deleteAttachment);
